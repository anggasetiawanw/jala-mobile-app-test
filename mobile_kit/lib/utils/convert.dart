...
class Convert {
  ...
  static int? getPriceShrimpBySize(dynamic data, int size) {
    if (size == 20) {
      ...
      return data.size30 ?? 0;
    } else if (size == 40) {
      return data.size40 ?? 0;
    } else if (size == 50) {
      return data.size50 ?? 0;
    } else if (size == 60) {
      return data.size60 ?? 0;
    } else if (size == 70) {
      return data.size70 ?? 0;
    } else if (size == 80) {
      return data.size80 ?? 0;
    } else if (size == 90) {
      return data.size90 ?? 0;
    } else if (size == 100) {
      return data.size100 ?? 0;
    } else if (size == 110) {
      return data.size110 ?? 0;
    } else if (size == 120) {
      return data.size120 ?? 0;
    } else if (size == 130) {
      return data.size130 ?? 0;
    } else if (size == 140) {
      return data.size140 ?? 0;
    } else if (size == 150) {
      return data.size150 ?? 0;
    } else if (size == 160) {
      return data.size160 ?? 0;
    } else if (size == 170) {
      return data.size170 ?? 0;
    } else if (size == 180) {
      return data.size180 ?? 0;
    } else if (size == 190) {
      return data.size190 ?? 0;
    } else if (size == 200) {
      return data.size200 ?? 0;
    } else {
      return 0;
    }
  }
