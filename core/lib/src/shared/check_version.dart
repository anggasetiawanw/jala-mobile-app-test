...
class CheckVersion {
  ...
  Future<void> check(BuildContext context) async {
    ...
    if (Platform.isAndroid) {
      version = FirebaseRemoteConfig.instance.getString("mis_android_version");
      suggestionVersion = FirebaseRemoteConfig.instance.getString("mis_android_suggestion");
      if (version.isNotEmpty && suggestionVersion.isNotEmpty) {
        await _checkVersionUpdate(version, suggestionVersion);
      }
    } else {
      version = FirebaseRemoteConfig.instance.getString("mis_ios_version");
      suggestionVersion = FirebaseRemoteConfig.instance.getString("mis_ios_suggestion");
      if (version.isNotEmpty && suggestionVersion.isNotEmpty) {
        await _checkVersionUpdate(version, suggestionVersion);
      }
    }
